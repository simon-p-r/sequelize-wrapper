...
$tcp = $wmi.GetSmoObject("ManagedComputer[@Name='${env:computername}']/ServerProtocol[@Name='Tcp']")
$tcp.IsEnabled = $true
$tcp.Alter()

$wmi = New-Object('Microsoft.SqlServer.Management.Smo.Wmi.ManagedComputer')
$ipall = $wmi.GetSmoObject("ManagedComputer[@Name='${env:computername}']/ServerProtocol[@Name='Tcp']/IPAddress[@Name='IPAll']")
